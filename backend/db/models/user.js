...
const bcrypt = require('bcryptjs'); // bcryptjs package to compare the password and the hashedPassword
...
module.exports = (sequelize, DataTypes) => {
  ...
  // Returns true of false based on the password comparison to the hashedPassword
